...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = ((Math.abs(row1 - row0) <= 1
                && Math.abs(col0 - col1) <= 1));
        _isJump = !((Math.abs(row1 - row0) <= 1
                && Math.abs(col0 - col1) <= 1));
    }
    ...
    public String toString() {
        ...
        nextMove = new char[]{_col0, _row0, '-', _col1, _row1};
        newMoveString = new String(nextMove);
