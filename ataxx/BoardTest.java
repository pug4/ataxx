...
public class BoardTest {
    ...
    private static final PieceColor[][] TESTRESULT = {
            {RED, BLOCKED, BLOCKED, RED, BLOCKED, BLOCKED, BLUE},
            {BLOCKED, RED, BLOCKED, RED, BLOCKED, BLUE, BLOCKED},
            {BLOCKED, BLOCKED, RED, RED, BLUE, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, BLOCKED, RED, BLOCKED, BLOCKED, BLOCKED},
            {BLOCKED, BLOCKED, RED, RED, RED, BLOCKED, BLOCKED},
            {BLOCKED, RED, BLOCKED, RED, BLOCKED, RED, BLOCKED},
            {RED, BLOCKED, BLOCKED, BLUE, BLOCKED, BLOCKED, RED}
    };
    ...
    public void check() {
        ...
        test.setBlock('b', '4');
        test.setBlock('c', '4');
        makeMoves(test, GAMETEST);
        checkBoard(test, TESTRESULT);
